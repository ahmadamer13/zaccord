          ...
          if (result.length > 3) {
            showMoreBtn = `
              ...
              <p class="align note ddgray">
                Order prices do not include shipping and other fees!
              </p>
            `;
          }
        }).then(o => {
          ...
          genDelivery(conn, userID).then(data => {
            ...
            output += `
              ...
              <p class="note align ddgray">
                You can change your delivery details any time, including during checkout.
              </p>
              <hr class="hrStyle">
              <div class="flexDiv" style="flex-wrap: wrap; justify-content: space-evenly;">
                <input type="password" class="dFormField" id="cpass"
                  placeholder="Current password">
                <input type="password" class="dFormField" id="pass" placeholder="New password">
                <input type="password" class="dFormField" id="rpass" placeholder="Repeat password">
              </div>
