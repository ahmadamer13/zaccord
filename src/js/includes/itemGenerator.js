...
function produceShowcaseOutput(result, isDefault, i, isUneven = false, isBest = false, priceOverride = null) {
  ...
  let output = `
    <a href="/${url}" class="align product-card-wrapper">
      ...
      <a href="${whatsappUrl}" target="_blank" rel="noopener noreferrer" class="whatsapp-order-btn" onclick="event.stopPropagation();">
