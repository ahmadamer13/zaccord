...
(4, 'Gold', 'plain', 'pla_arany.jpg', 'Well -printable', 'FFD700', 1),
...
(3, 'Hand.jpg', 'Mechanical hand', 'Mechanical hands consisting of several elements and finger minutes. The product depicts the human hand anatomically. In addition, finger minutes can be moved to the desired position. <br> \ R \ n Product <a href = \ "https: //www.jordan3dprint.com/item/product=127 \" class = \ "bluelink font16 \"> jordan3dprinton </a> and the package contains all the necessary assembly.', '0.2', '0.4', '40', '170,150,70', '2020-06-00 00:00:00'),
(4, 'Tree.jpg', 'Phosphorescent', 'Dark phosphorescent tree. The product is printed from a special filament that illuminates green in the dark and white in the light, rubber. jordan3dprinton is also possible to print from such a fillet on request.', '0.2', '0.4', '40', '130.90,100', '2020-06-00 00:00:00'),
(5, 'Woman.jpg', 'Naked female', 'Anatomically authentic, naked female upper body. It can be an ideal choice for lonely men. After <br> \ r \ nasty 3D scanning, it is possible to print the beautiful body of anyone on the jordan3dprint, so you can always take your beloved body with us.', '0.2', '0.4', '40', '130.90,100', '2020-06-00 00:00:00'),
...
(7, 'exoskeleton.jpg', 'Exoskeleton', 'Hand -mounted exoskeleton. The product consists of several elements that the customer has to assemble, but the package is all available in the package. It can be used immediately after assembly and looks very cool. <br> \ r \ n Product <a class = \ "bluelink font16 \" href = \ "https: //wwww.jordan3dprint.com/item/product=126 \"> jordan3dprinton can be purchased </a> and within a few days.', '0.2', '0.4', '40', '130.90,100', '2020-06-00 00:00:00'),
...
(9, 'vase.jpg', 'Spiral', 'Modern spiral vase. It can be a great choice for the apartment as a decoration, especially for the same, clean style homes. <br> \ r \ n Product <a class = \ "bluelink font16 \" href = \ "https: //www.jordan3dprint.com/item/product=131 \"> jordan3dprinton can be purchased </a> and in a few days.', '0.2', '0.4', '40', '130.90,100', '2020-06-00 00:00:00');
